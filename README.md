...
Dépôt tout juste créé et configuré (GitHub Pages activé, branche `main`,
dossier racine). Aucun contenu de fiches ni aucune web app n'a encore été
ajouté — ce sera fait dans une session ultérieure disposant du contexte des
choix déjà pris côté dépôt privé (format des fiches, conventions de nommage,
etc.).
